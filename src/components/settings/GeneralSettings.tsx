    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-6">
                {/* Data Export */}
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Data Maintenance</h3>
                    ...
                    {/* Reset Data */}
                    <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200 dark:bg-red-900/10 dark:border-red-900/30">
                        <div>
                    ...
                    {auditMsg && (
                        <div className="mt-2 text-xs font-mono p-2 bg-gray-100 rounded dark:bg-gray-800 dark:text-gray-300">
                            {auditMsg}
                        </div>
                    )}
                </div>
